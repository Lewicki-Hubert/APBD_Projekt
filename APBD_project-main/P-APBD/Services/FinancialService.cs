    ...
    public class FinancialService : IFinancialService
{
    ...
    public async Task<int> RecordProductAgreementPaymentInInstallments(ProductAgreementPaymentRequest request,
        int installments, CancellationToken cancellationToken)
    {
        request.Validate();
        return await _financialRepository.AddProductAgreementPaymentInInstallments(request, installments, cancellationToken);
    }

    public Task<int> RecordProductAgreementPayment(ProductAgreementPaymentRequest request, int installments,
